        ...
        <div className="max-w-4xl">
          <div className="flex items-center gap-3">
            <span
              ...
              style={{ background: `linear-gradient(90deg, ${accent}, color-mix(in oklab, ${accent} 50%, orange))` }}
            />
        ...
        <div className="mt-12 flex flex-wrap gap-3">
          {tabs.map((tab) => (
            <button
              ...
              style={
                activeTab === tab.label
                  ? { background: `linear-gradient(135deg, ${accent}, color-mix(in oklab, ${accent} 60%, orange))` }
                  : {}
              }
            >
              {tab.label}
          ...
          {activeCards.map((card) => (
            ...
            >
              <div
                ...
                style={{ background: `radial-gradient(circle at top right, color-mix(in oklab, ${accent} 14%, transparent), transparent 60%)` }}
              />
              <div className="flex items-start justify-between relative z-10">
                <div
                  className="grid h-12 w-12 place-items-center rounded-2xl"
                  style={{ background: `color-mix(in oklab, ${accent} 10%, white)` }}
                >
              ...
              <div
                ...
                style={{ background: `linear-gradient(90deg, ${accent}, color-mix(in oklab, ${accent} 60%, orange))` }}
              />
            </div>
          ))}
        </div>
