...
const role = getHireRoleProps("software-developers");

export const Route = createFileRoute("/hire/software-developers")({
  head: () => ({
    meta: [
  ...
  component: function HireSoftwareDevelopersPage() {
    return ( 
      <>
