export const studies = [
  // Schlinder - ware house management system - software development
  {
    ...
    headline:
      "Integrated Warehouse Management System achieved 91% verification accuracy and 100% seamless data traceability.",
    ...
    conclusion:
      "The Schindler Warehouse Management System serves as a robust digital foundation for material integrity and production efficiency. By centralizing measurements and automating the verification-to-labeling workflow, Pure Technology delivered a solution that ensures Schindler maintains its high standards for precision and data-driven manufacturing.",
  },
  ...
  // tata autocomp - software development
  {
    ...
    headline:
      "Digital 8D Problem Solving Platform achieved 100% digital adoption and 90% real-time complaint visibility.",
  ...
  // Bridgestone safety dashboard system - Software development
  {
    ...
    headline:
      "Centralized Safety Dashboard System digitized 90% of safety observations and cut manual reporting effort by 60%.",
    ...
    projectName:
      "Safety Dashboard System – Centralized Digital Platform for Safety Observation, Compliance & Incident Prevention",
    objective:
      "Bridgestone partnered with Pure Technology Solutions to transform its manual safety observation and reporting practices into a centralized, digital, real-time Safety Dashboard System. The goal was to eliminate manual entry gaps, strengthen compliance, automate reporting, ensure visibility across departments, and empower the safety team with live insights to support the mission of achieving a zero-incident environment.",
    solutions: [
  ...
  // Sandvik Vehicle Access Management System - Software development
  {
    ...
    headline:
      "Smart Vehicle Access Management System achieved 90% automated FastTag authentication and 80% real-time gate visibility.",
    ...
    projectName:
      "Vehicle Access Management System – A Smart, Secure & Automated Access Control Solution",
    objective:
      "Sandvik Coromant partnered with Pure Technology to modernize and automate its vehicle entry and parking management operations across multiple locations. The goal was to create a unified, secure, and intelligent system that seamlessly integrates with existing boom barriers, supports employee authentication, and enhances overall access control efficiency.",
    solutions: [
  ...
  // Bridgestone - Bladder Inventory Management  - Mobile app development
  {
    ...
    headline:
      "Bladder Inventory Management mobile app improved inventory accuracy by 75% and stock checking efficiency by 90%.",
    ...
    projectName:
      "Bladder Inventory Management System – Comprehensive Bladder Tracking & Stock Control Mobile Application",
    objective:
  ...
  // Visitor Pass Admin Pannel - web application
  {
    ...
    headline:
      "Comprehensive Visitor Pass admin panel improved visitor tracking by 70% and cut check-in time by 60%.",
    ...
    objective:
      "Visitor Pass is a comprehensive client admin panel designed to facilitate visitor management, member tracking, guard coordination, and departmental visitor analytics for organizations. The solution provides dashboard overview showing total users, total members, total guards, total visitors, department-based visitor summary with pie chart visualization, recent visitors list with timestamps, MOM (Month-over-Month) visitors tracking, and WOW (Week-over-Week) visitors trend analysis with complete user, member, and visitor management modules.",
    solutions: [
  ...
  // Bridgestone IOT & MTR Digitalization - Software Development
  {
    ...
    headline:
      "IoT and AI-driven MTR digitalization cut report generation time by 70% and reduced test errors by 90%.",
    ...
    objective:
      "To digitize the MTR raw material testing process by implementing IoT-enabled data capture, AI-driven analytics, and cloud-based reporting, aiming to eliminate manual errors, enhance operational efficiency, and enable real-time quality monitoring for faster and smarter decision-making.",
    solutions: [
    ...
    conclusion:
      "By digitalizing the MTR raw material testing process, the client achieved faster, more accurate, and reliable operations. The integrated IoT and AI-driven solution not only streamlined workflows but also empowered real-time decision-making, setting the foundation for scalable and intelligent manufacturing.",
  },
  // Bridgestone 3d cad powered MME Trolly system - Software development
  {
    ...
    headline:
      "3D CAD-powered MHE Trolly system achieved 100% paperless operations and cut response time by 50%.",
    ...
    conclusion:
      "By leveraging 3D CAD technology, MHETrolly has redefined MHE trolley maintenance, ensuring faster repairs, cost reductions, and seamless digital tracking. A game-changer in material handling automation.",
  },
  ...
  // Bridgestone KPI dashboard - software development
  {
    ...
    headline:
      "Power BI KPI Dashboard boosted production efficiency by 20% and delivered 40% faster reporting.",
    ...
    objective:
      "Develop a Power BI-based KPI Dashboard to streamline production tracking, defect analysis, power consumption, and overall plant efficiency.",
    solutions: [
    ...
    conclusion:
      "The Bridgestone KPI Dashboard project revolutionized operations, driving a 20% efficiency boost and 40% faster reporting. By automating data collection, the solution empowered the organization with real-time insights and proactive quality control.",
  },
  ...
  // Bridgestone TMA usage monitoring - software development
  {
    ...
    headline:
      "Power BI and AI-driven TMA project cut reporting time by 60% and boosted data accuracy by 40%.",
  ...
  // Bridgestone dot serial code case - web development
  {
    ...
    headline:
      "AI-powered Dot Serial Code Generation delivered 100% accuracy and cut process time by 50%.",
    ...
    conclusion:
      "The AI-powered Dot Serial Code Generation System has transformed accuracy, efficiency, and productivity. With automation eliminating manual efforts and ensuring real-time validation, the system delivers exceptional ROI, saving time and resources while boosting operational performance.",
  },
  ...
  // CEAT - SD
  {
    ...
    headline:
      "AI-powered tire verification system achieved 99% barcode accuracy and cut inspection time by 80%.",
    ...
    conclusion:
      "The AI-powered verification system transformed manual tire inspections into an efficient, automated process — boosting accuracy, reducing costs, and streamlining operations. This project highlights the impact of smart technologies in modernizing manufacturing workflows.",
  },
  ...
  // Bridgestone tyre manufacturing - Mobile application
  {
    ...
    headline:
      "IoT and Power BI-driven diesel management reduced fuel wastage by 30% and accelerated fuel decisions by 50%.",
    ...
    objective:
      "The objective of the Diesel Project was to optimize diesel consumption by using IoT for real-time monitoring and Power BI for data analysis, enabling accurate tracking, reduced wastage, and improved operational efficiency.",
    solutions: [
    ...
    conclusion:
      "With IoT-enabled automation and AI-driven analytics, the Diesel Project has streamlined fuel tracking, enhanced operational efficiency, and reduced costs significantly.",
  },
  ...
  // Tata Taco - SD
  {
    ...
    headline:
      "TQM-powered digital portal reduced repetitive task defects by 40% and boosted Kaizen participation by 60%.",
    ...
    objective:
      "An advanced digital portal was implemented to drive structured operational management and workflow optimization. The solution embedded TQM principles and lean methodologies to improve key areas: Abnormality Management, Near Miss Management, Suggestion Management, Safety Walks, and Kaizen Management.",
    solutions: [
    ...
    conclusion:
      "Integrating TQM tools and lean methodology into a centralized web portal transformed operational practices and safety, driving continuous improvement. This solution sets a benchmark for organizations seeking operational excellence and innovation.",
  },

  {
    ...
    objective:
      "AI-powered interview preparation platform transforming candidate training. Delivers simulations, speech analytics, and proctoring—improving success rates by 78%.",
    solutions: [
  ...
  // Cloud wise
  {
    ...
    headline:
      "Fully on-premises AI platform achieved 300%+ ROI while maintaining zero-breach security.",
    ...
    objective:
      "On-premises AI platform delivering enterprise capabilities without internet dependency. Enables document processing, workflow automation, and analytics while maintaining data sovereignty and encryption.",
    solutions: [
    ...
    conclusion:
      "Cloudwise AI established secure on-premises infrastructure eliminating internet dependencies while enabling unprecedented operational efficiencies and maintaining highest security standards.",
  },
  // QgenX
  {
    ...
    headline:
      "AI-powered content suite scaled article production from 50 to 200+ monthly with 75% cost reduction.",
    ...
    objective:
      "AI-powered content creation suite revolutionizing digital content production. Generates articles, questions, product descriptions, and AI imagery—reducing costs by 75%.",
    solutions: [
    ...
    conclusion:
      "QgenX.ai established scalable production framework eliminating bottlenecks and delivering measurable SEO improvements at unprecedented scale.",
  },
  // AI Calling BOT
  {
    ...
    headline:
      "Intelligent voice automation scaled daily calls from 500 to 5,000+ while boosting conversions from 12% to 65%.",
    ...
    objective:
      "Intelligent voice automation platform revolutionizing lead engagement. Autonomously initiates calls, schedules meetings, and updates CRM—increasing conversions by 65%.",
    solutions: [
    ...
    conclusion:
      "AI Calling Bot transformed sales operations establishing intelligent automation ecosystem dramatically multiplying capacity while reducing costs and improving satisfaction.",
  },
  // Astrology AI
  {
    ...
    image: "https://res.cloudinary.com/dra0hwsh4/image/upload/v1781510624/astrologyAi_dh4t4g.png",
    headline:
      "AI Vedic astrology platform serves 100,000+ users across 45 countries with 95% satisfaction rate.",
    ...
    objective:
      "AI platform merging Vedic wisdom with technology delivering personalized astrological guidance. Provides instant consultations—serving 100,000+ users with 95% satisfaction.",
    solutions: [
    ...
    conclusion:
      "Astrology AI bridged ancient Vedic wisdom and modern accessibility creating authentic personalized guidance system democratizing expert-level consultation globally.",
  },
  // find my face
  {
    ...
    headline:
      "AI facial recognition platform reduced post-production time from 25 to 3 hours while scaling discovery rates from 30% to 94%.",
    ...
    objective:
      "AI-powered facial recognition platform transforming event photo discovery. Guests upload selfies to instantly retrieve all photos—reducing post-production time by 85%.",
    solutions: [
    ...
    conclusion:
      "FindMyFace revolutionized event photography establishing intelligent discovery ecosystem eliminating manual bottlenecks while maintaining privacy standards and enhancing experiences.",
  },
  // Paint Minds
  {
    client: "PaintMinds",
    ...
    headline:
      "AI-powered resume parsing platform improved hiring efficiency by 85% while achieving 100% response speed.",
    ...
    objective:
      "To revolutionize resume parsing with AI technology to streamline recruitment processes, improve candidate matching accuracy, and enhance overall hiring efficiency. The goal is to solve the complex task of validating resume relevancy against job descriptions for both HR professionals and job seekers.",
    solutions: [
  ...
  // Enterprise Software Solutions - Generative ai development
  {
    ...
    headline:
      "AI-powered Q&A platform reduced support by 50% while achieving 100% response on documentation.",
    ...
    objective:
      "To build a scalable, AI-driven Q&A web application that enables users to query complex product documentation using natural language. This solution aims to significantly reduce manual support overhead and enhance internal efficiency by providing instant, accurate technical answers.",
    solutions: [
    ...
    conclusion:
      "This AI-Powered Knowledge Assistant successfully bridged the gap between complex technical documentation and user needs. By transforming static manuals into an interactive Q&A experience, the project delivered measurable improvements in both customer satisfaction and internal operational efficiency.",
  },
...

  {
    ...
    headline:
      "AI fraud detection system achieved 80% faster response time with 100% operational speed on bank statement verification.",
...

  {
    ...
    headline:
      "AI voice agent automated HR screening achieving 70% faster screening velocity and 100% candidate handling.",
    ...
    objective:
      "To eliminate manual bottlenecks in early-stage hiring by deploying an AI voice agent that automates candidate screening, interview coordination, and communication assessment—boosting speed, consistency, and scalability across the recruitment lifecycle.",
    solutions: [
    ...
    conclusion:
      "The AI Voice Agent successfully transformed the recruitment funnel from a manual, time-intensive process into a high-speed, data-driven operation. By automating the first leg of hiring, the solution ensures that only the best-fit, highly-vetted candidates reach human recruiters, maximizing efficiency and hiring quality.",
  },
];
